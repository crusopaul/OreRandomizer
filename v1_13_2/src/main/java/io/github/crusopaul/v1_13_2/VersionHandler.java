...
public class VersionHandler extends VersionInterface {
    ...
    private io.github.crusopaul.v1_13_2.ToggleCreeperSound toggleCreeperSound;
    ...
    public void instantiate (FileConfiguration configFileToSet, File configToSet) {
        ...
        this.toggleCreeperSound = new io.github.crusopaul.v1_13_2.ToggleCreeperSound(this.oreListener);
